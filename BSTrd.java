...
public class BSTrd implements java.io.Serializable {
   ...
   //print tree helper function given to us
	...
	MNode yNode = new MNode("Joe", 7890, 2,2, true);
	MNode zNode = new MNode("Jack", 2234, 3,3, true);
	MNode kNode = new MNode("Jill", 7856, 4,4, true);
	MNode aNode = new MNode("Abe", 6788, 5,5, true);
	MNode bNode = new MNode("Beth", 7898, 6,6, true);
	MNode cNode = new MNode("Chuck", 2238, 7,7, true);
	MNode dNode = new MNode("Dot", 7858, 8,8, true);
	MNode mNode = new MNode("Mike", 2237, 9,9, true);
	MNode nNode = new MNode("Nick", 7857, 10,10, true);
	MNode oNode = new MNode("Otis", 2222, 11,11, true);
	a.insert(xNode);
	a.insert(yNode);
	a.insert(zNode);
	a.insert(kNode);
